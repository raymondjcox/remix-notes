...
export default function Index() {
  ...
  const editor = useEditor({
    editorProps: {
      attributes: {
        class:
          "prose prose-sm sm:prose prose-slate dark:prose-invert !max-w-none selection:bg-emerald-300 selection:text-emerald-900 h-full p-2 resize-none outline-none",
      },
    },
    extensions: [
      CustomDocument,
